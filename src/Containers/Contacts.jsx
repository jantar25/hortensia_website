...
const Contacts = () => {
  return (
    <div className='flex flex-col px-4 lg:px-20 pt-16 bg-blog' id='contacts'>
            ...
            <div className='flex flex-col md:flex-row'>
                <div className='flex-1'>
                    ...
                    <div className='mt-8'>
                        ...
                        <div data-aos="zoom-in" className='flex items-center justify-start mt-4'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='w-[30px] h-[3px] bg-text shadow-lg mt-2 mb-8'/>
                    <form data-aos="zoom-in" className='flex flex-col my-4 lg:ml-4 max-w-5/6 text-black'>
