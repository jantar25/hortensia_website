  ...
  return (
    <div className='relative px-4 lg:px-20 bg-bg py-10 xl:py-24 text-white skew-y-3 rounded-bl-[40px]' id='treatment'>
        ...
        <div className="-skew-y-3 bg-bg text-white flex flex-col items-center justify-center md:flex-row md:items-start md:justify-start my-4">
            <div data-aos="fade-right" className='flex-1 mb-4 md:mb-0 md:mr-2'>
            ...
            <div data-aos="fade-left" className="flex-1 relative md:flex justify-center items-center">
              <div className='flex items-start bg-[#eeb984] w-[260px] h-[284px] sm:w-[350px] sm:h-[510px] rounded-lg'>
