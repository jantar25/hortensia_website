        ...
        <div className="-skew-y-3 bg-bg text-white flex flex-col items-center justify-center md:flex-row md:items-start md:justify-start my-4">
            <div className='flex-1 mb-4 md:mb-0'>
              ...
              <div className="text-gray-300">
                <p>The range of practices that support skin integrity, enhance its appearance, and relieve skin conditions</p>
              </div>
            </div>
            <div className="flex-1 relative md:flex justify-center items-center">
              <div className='flex items-start bg-[#eeb984] w-[260px] h-[284px] sm:w-[360px] sm:h-[510px] rounded-lg'>
                  <div className=' bg-text self-start w-[260px] h-[284px] sm:w-[360px] sm:h-[510px] mt-4 -ml-4 rounded-lg'>
